...
def test_silhouette_samples_cosine():
    ...
    assert np.allclose(
        scdice_metrics.utils.silhouette_samples(X, labels, metric="cosine"),
...
def test_silhouette_samples_nearest():
    X, labels = dummy_x_labels()
    assert np.allclose(
        scdice_metrics.utils.silhouette_samples(X, labels, between_cluster_distances="nearest"),
...
def test_silhouette_samples_mean_other():
    X, labels = dummy_x_labels()
    assert np.allclose(
        scdice_metrics.utils.silhouette_samples(X, labels, between_cluster_distances="mean_other"),
...
def test_silhouette_samples_furthest():
    X, labels = dummy_x_labels()
    assert np.allclose(
        scdice_metrics.utils.silhouette_samples(X, labels, between_cluster_distances="furthest"),
...
def test_silhouette_label_cosine():
    X, labels = dummy_x_labels()
    score = scdice_metrics.silhouette_label(X, labels, metric="cosine")
...
def test_bras():
    ...
    score = scdice_metrics.bras(ad.obsm[emb_keys[0]], ad.obs[labels_key], ad.obs[batch_key])
...
def test_silhouette_batch_default():
    ad, emb_keys, batch_key, labels_key = dummy_benchmarker_adata()
    score = scdice_metrics.silhouette_batch(ad.obsm[emb_keys[0]], ad.obs[labels_key], ad.obs[batch_key])
...
def test_silhouette_batch_cosine():
    ad, emb_keys, batch_key, labels_key = dummy_benchmarker_adata()
    score = scdice_metrics.silhouette_batch(ad.obsm[emb_keys[0]], ad.obs[labels_key], ad.obs[batch_key], metric="cosine")
...
def test_silhouette_batch_nearest():
    ad, emb_keys, batch_key, labels_key = dummy_benchmarker_adata()
    score = scdice_metrics.silhouette_batch(
